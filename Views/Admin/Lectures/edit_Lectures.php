...
<head>
    <title> Admin | Edit Lectures </title>
    ...
    <div class="container-fluid ">
       ...
       <?php
         include_once('../Template/checkUser.php');
          include_once("Logic/edit_Lectures_logic.php");
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-success">
                                <div class="panel-heading ">
                                     <h2 class="pull-left"><span class="glyphicon glyphicon-door "></span> <a href="Lectures.php" class=" label label-success">Back to Lectures</a></h2>
                                      <?php 
                                ...
                                <div class="panel-body">
                                    ...
                                    <form class="form-horizontal" action="<?php echo htmlspecialchars($_SERVER[" PHP_SELF "]);?>" method="post" id="">
                                        <div class="form-group">
                                            <label for="AC_CourseName" class="col-sm-4 control-label">Lectures Name</label>
                                            <div class="col-sm-8">
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-offset-2 col-sm-10">
                                                <button type="submit" class="btn btn-success col-xs-12" id="generateReportBtn"> <i class="glyphicon glyphicon-ok-sign"></i> Save Changes</button>
                                            </div>
                                        </div>
